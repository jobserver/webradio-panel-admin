angular.module("ui.materialize", ["ui.materialize.ngModel","ui.materialize.materialboxed","ui.materialize.tabs", "ui.materialize.sidenav","ui.materialize.slider","ui.materialize.collapsible","ui.materialize.material_select", "ui.materialize.inputfield", "ui.materialize.input_date","ui.materialize.modal","ui.materialize.dropdown","ui.materialize.pagination"]);
...
.directive("materialSelect", ["$compile", "$timeout","$parse", function ($compile, $timeout,$parse) {
 return {
  scope:{
        contaAtiva:'=ngModel'
    },
    ...
    function initSelect() 
    {
     element.siblings(".caret").remove();
                   // element.material_select();
                    //console.log(scope.contaAtiva);
                  $('.jobsSelect').val(scope.$eval(attrs.ngModel));
                   element.formSelect();                    
            }
                 $timeout(initSelect);
                 if (attrs.ngModel) {
